...
using DigitalShopResturant.Data;
using DigitalShopResturant.Models;
using DigitalShopResturant.Models.ViewModels;
using DigitalShopResturant.Service;
...
namespace DigitalShopResturant.Areas.Customer.Controllers
{
  [Area("Customer")]
  public class OrderController : Controller
  {
    ...
    public async Task<IActionResult> ManageOrder(int productPage = 1)
    {
      ...
      List<OrderHeader> OrderHeaderList = await _db.OrderHeaders.Where(o => o.Status == SD.StatusSubmitted || o.Status == SD.StatusInProcess).OrderByDescending(u => u.PickUpTime).ToListAsync();
